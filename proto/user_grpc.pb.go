...
func (c *userClient) CreateUser(ctx context.Context, in *UserCreateRequest, opts ...grpc.CallOption) (*UserCreateResponse, error) {
...
func (UnimplementedUserServer) CreateUser(context.Context, *UserCreateRequest) (*UserCreateResponse, error) {
